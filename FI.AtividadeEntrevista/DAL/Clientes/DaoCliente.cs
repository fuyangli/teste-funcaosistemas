...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long IncluirBeneficiario(Beneficiario beneficiario)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("IDCLIENT", beneficiario.ClientId));
        ...
        internal List<Beneficiario> ListarBeneficiarios(long id)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
        ...
        internal bool VerificarExistencia(string CPF, long? clientId = 0)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            {
                parametros.Add(new System.Data.SqlClient.SqlParameter("clienteId", clientId.Value));
            }
